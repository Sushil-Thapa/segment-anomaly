...
class IoUMetric:
    ...
    def __init__(
        self, num_classes: int = 2, ignore_index: int = -100, smooth: float = 1e-6
    ):
        """
...
class F1Metric:
    ...
    def __init__(
        self, num_classes: int = 2, ignore_index: int = -100, average: str = "macro"
    ):
        """
...
def compute_metrics(
    predictions: torch.Tensor, targets: torch.Tensor, num_classes: int = 2
) -> Dict[str, float]:
    """
